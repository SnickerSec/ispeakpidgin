        ...
        beginner: [
            {
                ...
                icon: '<iconify-icon icon="lucide:hand"></iconify-icon>',
                content: {
                    vocabulary: [
            ...
            },
            {
                id: 'food',
                title: 'Food & Eating',
                icon: '<iconify-icon icon="lucide:utensils"></iconify-icon>',
                content: {
                    vocabulary: [
        ...
        intermediate: [
            {
                ...
                icon: '<iconify-icon icon="lucide:party-popper"></iconify-icon>',
                content: {
                    vocabulary: [
