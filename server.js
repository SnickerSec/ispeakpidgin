...
// In-memory cache for dictionary (shared across modules)
let dictionaryCache = {
    data: null,
    timestamp: 0,
    ttl: 5 * 60 * 1000
...
// Use modular translation routes
app.use('/api/translate', translateRoutes(translate, translationLimiter, dictionaryCache));
app.post('/api/text-to-speech', translateRoutes(translate, translationLimiter, dictionaryCache));
app.post('/api/translate-llm', translateRoutes(translate, translationLimiter, dictionaryCache));
...
// Use modular dictionary routes
app.use('/api/dictionary', dictionaryRoutes(supabase, dictionaryLimiter));
