...
class PronunciationPractice {
    ...
    englishToPidginMap = {
        ...
        "pow hannah": "pau hana",
        "pal hana": "pau hana",
        "call hannah": "pau hana",
        "paul hana": "pau hana",
        "paul hannah": "pau hana",
        "paw hana": "pau hana",
        "pa hana": "pau hana",
        "pow hanna": "pau hana",
        "how hannah": "pau hana",
        ...
        "messed up": "hamajang",
        "broken": "hamajang",
        "all messed up": "hamajang",
        "goosebumps": "chicken skin",
        "goose bumps": "chicken skin",
        "food coma": "kanak attack",
        "cannot attack": "kanak attack",
        "chronic attack": "kanak attack",
        "canada attack": "kanak attack",
        "finished": "pau",
        "done": "pau",
        "after work": "pau hana",
        "off work": "pau hana",
        ...
        "sea": "kai",
        "mountain": "mauka",
        "toward mountain": "mauka",
        "toward ocean": "makai",
        "food": "grindz",
        "eat": "grind",
        "eating": "grinding",

        // Hawaiian/Pidgin words often misheard
        "howley": "haole",
        "how lee": "haole",
        "holly": "haole",
        "holy": "haole",
        ...
        "who la": "hula",
        "hoola": "hula",
        "you ka lay lee": "ukulele",
        "wicky wicky": "wiki wiki",
        "poo poo": "pupu",
        "mala sada": "malasada",
        "melissa da": "malasada",
        "shaved ice": "shave ice",
        "pooka": "puka",
        "puca": "puka",
        "hole": "puka",
        "slippers": "slippahs",
        "slip oz": "slippahs",
        "rubber slippers": "rubbah slippahs",
        "rubber slip oz": "rubbah slippahs",
        "talk stank": "talk stink",
        "stinky eye": "stink eye",
        "hang lose": "hang loose",
        "shock a": "shaka",
        "shocker": "shaka",
        "shaka bra": "shaka brah",
        "shockabra": "shaka brah",
        "joke": "choke",
        "oh no grins": "ono grindz",
        "ono grinds": "ono grindz",
        "delicious food": "ono grindz",

        // Additional practice words mappings
        "low low": "lau lau",
        "lau lau": "lau lau",
        "allow": "lau lau",
        "colloidal pig": "kalua pig",
        "kahlua pig": "kalua pig",
        "kayla pig": "kalua pig",
        "blue a pig": "kalua pig",
        "kalua": "kalua",
        "kahlua": "kalua",
        "move to be": "musubi",
        "moo sue be": "musubi",
        "moo so be": "musubi",
        "sue be": "musubi",
        "low co moco": "loco moco",
        "loco moko": "loco moco",
        "local moco": "loco moco",
        "low co mo co": "loco moco",
        "boy": "poi",
        "poy": "poi",
        "the best": "da bes",
        "the bass": "da bes",
        ...
        "system": "sistah",
        "comma aina": "kamaaina",
        "come on aina": "kamaaina",
        "comma i know": "kamaaina",
        "molly heeny": "malihini",
        "mali hini": "malihini",
        "mala heeny": "malihini",
        "la nai": "lanai",
        "the night": "lanai",
        "we key we key": "wiki wiki",
        "wiki": "wiki wiki",
        "we key": "wiki wiki",
        "poopoo": "pupu",
        "poo poo": "pupu",
        ...
        "flipflops": "slippahs",
        "talk stank": "talk stink",
        "talkstink": "talk stink",
        "stinky i": "stink eye",
        "stink i": "stink eye",
        "dirty look": "stink eye",
        "boom bye": "bumbye",
        "bum by": "bumbye",
        "by and by": "bumbye",
        "eventually": "bumbye",
        ...
        "roger dat": "rajah dat",
        "raja dat": "rajah dat",
        "oh no grinds": "ono grindz",
        "small kind": "small kine",
        "small cane": "small kine",
        "a little bit": "small kine",
        "broke the mouth": "broke da mouth",
        "break the mouth": "broke da mouth",
        "goosebumps": "chicken skin",
        "goose bumps": "chicken skin",
        "more better": "mo bettah",
        "much better": "mo bettah",
        "mo better": "mo bettah",
        "talkstory": "talk story",
        "talk stories": "talk story",
        "chat": "talk story",
    ...
    pidginToEnglishMap = {
        ...
        'pau hana': ["pow hana", "pow hannah", "pal hana", "pau hana", "call hannah", "paul hana", "paul hannah", "paw hana", "pa hana", "how hannah", "how hana", "pal hannah", "pow ana", "pau ana"],
        ...
        'choke': ["choke", "a lot", "plenty", "joke"],
        'shaka': ["shaka", "shock a", "shocker", "shaka bra", "shockabra"],
        'kanak attack': ["kanak attack", "cannot attack", "chronic attack", "canada attack", "food coma"],
        'keiki': ["keiki", "cake e", "kay key", "k key", "child", "children"],
        'wahine': ["wahine", "wahini", "wa heeny", "wa hee nee", "woman"],
        'kane': ["kane", "kah nay", "connie", "man"],
        'tutu': ["tutu", "two two", "to to", "grandma", "grandmother"],
        'haole': ["haole", "howley", "how lee", "holly", "holy"],
        'mauka': ["mauka", "mao ka", "mow ka", "mocha", "toward mountain"],
        'makai': ["makai", "mackeye", "mckay", "mckye", "toward ocean"],
        'aloha': ["aloha", "a low ha", "hello ha"],
        'ohana': ["ohana", "o hana", "oh hannah", "oh hana", "family"],
        'poke': ["poke", "pokey", "poki", "po kay"],
        'luau': ["luau", "lou al", "lou ow", "loo ow"],
        'lanai': ["lanai", "la nigh", "la nye", "lawn eye"],
        'lei': ["lei", "lay", "lei"],
        'hula': ["hula", "who la", "hoola"],
        'ukulele': ["ukulele", "ukulele", "you ka lay lee"],
        'wiki wiki': ["wiki wiki", "wicky wicky", "wikiwiki"],
        'pupu': ["pupu", "poo poo", "poopoo", "appetizer"],
        'malasada': ["malasada", "mala sada", "melissa da"],
        'shave ice': ["shave ice", "shaved ice", "shaveice"],
        'puka': ["puka", "pooka", "puca", "hole"],
        'slippahs': ["slippahs", "slippers", "slip oz"],
        'rubbah slippahs': ["rubbah slippahs", "rubber slippers", "rubber slip oz"],
        'talk stink': ["talk stink", "talkstink", "talk stank"],
        'stink eye': ["stink eye", "stinkeye", "stinky eye"],
        'hang loose': ["hang loose", "hang lose", "hangloose"],
        'no worry': ["no worry", "no worries", "don't worry"],
        'geev um': ["geev um", "give em", "give um", "give it"],
        'ono grindz': ["ono grindz", "oh no grins", "ono grinds", "delicious food"],
        'lau lau': ["lau lau", "low low", "allow", "la la"],
        'kalua pig': ["kalua pig", "kahlua pig", "kayla pig", "blue a pig", "colloidal pig"],
        'kalua': ["kalua", "kahlua", "kayla", "blue a"],
        'musubi': ["musubi", "move to be", "moo sue be", "moo so be", "sue be"],
        'loco moco': ["loco moco", "low co moco", "loco moko", "local moco", "low co mo co"],
        'poi': ["poi", "boy", "poy"],
        'da bes': ["da bes", "the best", "the bass", "da best"],
        'fo real': ["fo real", "for real", "four real"],
        'no can': ["no can", "no can do", "cannot"],
        'plate lunch': ["plate lunch", "play lunch", "plate launch"],
        'malasada': ["malasada", "mala sada", "melissa da", "malla soda"],
        'pupule': ["pupule", "poopoolay", "poo poo lay", "poopoo", "pu pu lay"],
        'lidat': ["lidat", "like that", "like dat", "lie dat", "lee dat"],
        'bumbye': ["bumbye", "bum bye", "boom bye", "by and by", "bum by"],
        'stink eye': ["stink eye", "stinky eye", "stinky i", "stink i", "dirty look"],
        'talk stink': ["talk stink", "talk stank", "talkstink"],
        'slippahs': ["slippahs", "slippers", "slipper", "flip flops", "flipflops"],
        'rubbah slippahs': ["rubbah slippahs", "rubber slippers", "rubber slipper"],
        'kamaaina': ["kamaaina", "comma aina", "come on aina", "comma i know", "kama aina"],
        'malihini': ["malihini", "molly heeny", "mali hini", "mala heeny"],
        'lanai': ["lanai", "la nai", "la nigh", "the night", "lawn eye"],
        'wiki wiki': ["wiki wiki", "we key we key", "wicky wicky", "wiki"],
        'pupu': ["pupu", "poo poo", "poopoo", "appetizer", "appetizers"],
        'shave ice': ["shave ice", "shaved ice", "shaveice"],
        'puka': ["puka", "pooka", "puca"],
        'choke': ["choke", "joke", "a lot", "lots", "plenty"],
        'mauka': ["mauka", "mao ka", "moe ka", "mocha", "mow ka"],
        'makai': ["makai", "mo kai", "mock eye", "my chi", "mckay"],
        'small kine': ["small kine", "small kind", "small cane", "a little bit"],
        'broke da mouth': ["broke da mouth", "broke the mouth", "break the mouth"],
        'chicken skin': ["chicken skin", "goosebumps", "goose bumps"],
        'mo bettah': ["mo bettah", "more better", "much better", "mo better"],
        'talk story': ["talk story", "talkstory", "talk stories", "chat"],
        'pau hana': ["pau hana", "pow hana", "pow hannah", "call hannah", "how hannah", "pow on a", "power hana", "happy hour"]
    };
